          ...
          Column(
            ...
            children: [
              Text(
                ...
                style:
                    GoogleFonts.dmSans(fontSize: 12, color: AppTheme.textMuted),
              ),
              Text(
                inCart
    ...
    return Container(
      ...
      child: Row(children: [
        _Btn(
          ...
          color: qty <= 1 ? AppTheme.accent : AppTheme.primary,
          onTap: onDec,
        ),
        Expanded(
          child: Center(
        ...
        _Btn(icon: Icons.add_rounded, color: AppTheme.primary, onTap: onInc),
      ]),
    );
  }
}
...
class _Btn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: onTap,
      child: SizedBox(
          width: 52, height: 52, child: Icon(icon, color: color, size: 20)),
    );
  }
}
